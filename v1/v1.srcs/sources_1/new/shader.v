...
module shader(input [4:0] fader,
    ...
    wire [3:0] shader_red = (text_alpha ? text_r : (bg_alpha ? bg_r : 0));
    wire [3:0] shader_green = (text_alpha ? text_g : (bg_alpha ? bg_g : 0));
    wire [3:0] shader_blue = (text_alpha ? text_b : (bg_alpha ? bg_b : 0));
