...
module shader(input [4:0] fader,
        ...
        input [3:0] latiku_final_lap_r, input [3:0] latiku_final_lap_g, input [3:0] latiku_final_lap_b, input latiku_final_lap_alpha,
    ...
    wire [3:0] shader_red = (text_alpha ? text_r : 
            ...
            (latiku_final_lap_alpha ? latiku_final_lap_r :
            (timer_alpha ? timer_r :
    ...
    wire [3:0] shader_green = (text_alpha ? text_g : 
            ...
            (latiku_final_lap_alpha ? latiku_final_lap_g :
            (timer_alpha ? timer_g :
